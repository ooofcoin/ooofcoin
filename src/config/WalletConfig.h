...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "cccf";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "OOOF";
    ...
    const std::string daemonName = "OoofCoind";

    /* The name to call this wallet */
    const std::string walletName = "ooofwallet";

    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "ooof-service";
